...
The algorithm for the main application (functions, FreeRTOS tasks and software timer) is represented with flowcharts. The flowcharts can be found in the ``Flowcharts`` folder in this repo.  
