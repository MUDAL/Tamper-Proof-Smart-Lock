...
extern void SPI_Init(SPI_TypeDef* spiPort, uint32_t config);
extern void SPI_WriteByte(SPI_TypeDef* spiPort, uint8_t* pByte);
extern void SPI_WriteBytes(SPI_TypeDef* spiPort, uint8_t* pData, uint16_t length);
extern uint8_t SPI_ReceiveByte(SPI_TypeDef* spiPort);
extern void SPI_Transceive(SPI_TypeDef* spiPort, uint8_t* txData, uint8_t* rxData);
